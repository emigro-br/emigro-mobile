...
const KYC = () => {
  ...
  const handleStartKYC = () => {
    Inquiry.fromTemplate(templateId)
      ...
      .referenceId(userId) // Associate inquiry with the user
          ...
          <View>
            ...
            <Text style={styles.description}>
              {kycVerified
                ...
                : 'Please click the button below to start the KYC process. Your verification will be secured handled by Persona.'}
            </Text>
          </View>
...
const styles = StyleSheet.create({
  container: {
    ...
    marginTop: 10, // Add additional margin if needed
  },
  title: {
    fontSize: 20,
    fontWeight: 'bold',
