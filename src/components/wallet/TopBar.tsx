...
export const TopBar = () => {
  ...
  const [historyVisible, setHistoryVisible] = useState(false); // <-- ADD THIS
  const router = useRouter();

  return (
    <>
      <VStack className="px-4 pt-8 pb-4 bg-background-0">
        <HStack className="items-center">
          ...
          <HStack className="ml-4">
            <Pressable
              ...
              onPress={() => setHistoryVisible(true)} // <-- open history modal
            >
