...
export const AnnouncementScroll = () => {
  ...
  const cards = [
    {
      title: 'First reward Season',
      description: 'Pay with pix and onramp from Coinbase to rank up and win WL for the free NFT mint',
      image: require('@/assets/images/profile-temp.png'),
    },
    {
    ...
    <>
      ...
      >
        {cards.map((card, index) => (
          <Pressable key={index} onPress={() => setModalIndex(index)}>
            <Animated.View
style={{
  width: CARD_WIDTH,
  height: CARD_HEIGHT,
